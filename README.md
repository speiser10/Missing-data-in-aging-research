...
<img width="300" height="300" alt="Hist MCAR" src="https://github.com/user-attachments/assets/91e3c9d9-1538-4d16-b325-d01f710e1d24" />
<img width="300" height="300" alt="Hist MAR" src="https://github.com/user-attachments/assets/5110b6aa-fc28-45ea-bd14-3f52b32150c9" />
<img width="300" height="300" alt="Hist MNAR" src="https://github.com/user-attachments/assets/e28334ee-5326-4540-9414-33af87b5086b" />
...
<img width="300" height="300" alt="Scatter MCAR mean" src="https://github.com/user-attachments/assets/031dad0a-8286-48d5-95bd-4b29c6c387fd" />
<img width="300" height="300" alt="Scatter MAR mean" src="https://github.com/user-attachments/assets/021f607f-52c1-4091-bf92-8a22238c336e" />
<img width="300" height="300" alt="Scatter MNAR mean" src="https://github.com/user-attachments/assets/629fba27-a25c-436d-bd1a-9b1cf4b9ab85" />
...
<img width="300" height="300" alt="Scatter MCAR reg" src="https://github.com/user-attachments/assets/1b27f4ad-0ef3-4179-baab-100691c489c5" />
<img width="300" height="300" alt="Scatter MCAR missForest" src="https://github.com/user-attachments/assets/bb81cf01-2cf9-462c-b5c9-8b063e619cb4" />
<img width="300" height="300" alt="Scatter MNAR reg" src="https://github.com/user-attachments/assets/7999e926-262b-4ef0-898c-97401c0a0033" />
<img width="300" height="300" alt="Scatter MNAR missForest" src="https://github.com/user-attachments/assets/174b8d8e-a6f4-4824-9c25-25a877334690" />
<img width="300" height="300" alt="Scatter MAR reg" src="https://github.com/user-attachments/assets/ebd1bfc7-f87b-4b3b-b89f-c97f4e8af2a1" />
<img width="300" height="300" alt="Scatter MAR missForest" src="https://github.com/user-attachments/assets/382049ba-11f4-4520-b4f2-c72858735088" />

## Simulation Results

Under MCAR and MAR, all three imputation methods had an unbiased mean BMI.  Mean imputation and missForest underestimated variability, while regression imputation preserved the variability of BMI.  Mean imputation and missForest had lower MSE than regression imputation, which is expected because regression imputation introduces prediction error to preserve variability.
...
All of the code from this tutorial is posted to this GitHub page.  Each method and missing data mechanism is saved as a seperate R code file.  This tutorial demonstrates how to visualize missing data and shows how biased mean and variability estimates depend on both the missing mechanism and the imputation method.  
